...
{
    //private static Dummy instance = new Dummy(300, 60, 37, 60, 37, 0.35f, 7, 100);
    private int mana;
    public Dummy(float hp, float atk, float def, float mga, float mgd, float speed, float regen, int mana)
    {
    ...
    public override string QAttack(Champion target)
    {
        ...
        return "The dummy slapped you. Ouch!";
    }
    ...
    public override string WAttack(Champion target)
    {
        ...
        mana -= 50;
        target.SetStats(targetStats);
        return "The dummy prays. Somehow, its health is restored.";
    }
    ...
    //Checks for if Dummy can use spells
